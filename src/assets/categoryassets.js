...
export const category_list = [
    ...
    {
        category_name: "Lippan art",
        category_image: category_3
    },
    {
        category_name: "Flower crafts",
...
export const item_list = [
    {
        _id: "1",
        name: "Home decore Item1",
        image: item_1,
        price: 12,
        description: "every items are designed by designer to make all items beautifuly",
        category: "Home decore"
    },
    {
        _id: "2",
        name: "Home decore Item2",
        image: item_2,
        price: 18,
        description: "every items are designed by designer to make all items beautifuly",
        category: "Home decore"
    ...
    {
        _id: "13",
        name: "Flower crafts Item13",
        image: item_13,
        price: 12,
        description: "every items are designed by designer to make all items beautifuly",
        category: "Flower crafts"
    },
    {
        _id: "14",
        name: "Flower crafts Item14",
        image: item_14,
        price: 18,
        description: "every items are designed by designer to make all items beautifuly",
        category: "Flower crafts"
